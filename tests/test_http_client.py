...
from xpate_sdk.http_client import HttpClient
from xpate_sdk.http_client import HttpException
from xpate_sdk.http_client import RequestsHttpClient
...
class RequestsHttpClientTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        patcher = mock.patch('xpate_sdk.http_client.requests.request')
